...
#
#import os
#print(os.listdir("C:/Users/akash/Desktop/Walmart Sales Prediciton/input"))



dataset = pd.read_csv("Backup1.csv");
features = pd.read_csv("C:/Users/akash/Desktop/Walmart Sales Prediciton/input/features.csv",sep=',', header=0,
                       names=['Store','Date','Temperature','Fuel_Price','MarkDown1','MarkDown2','MarkDown3','MarkDown4',
                              'MarkDown5','CPI','Unemployment','IsHoliday']).drop(columns=['IsHoliday'])
stores = pd.read_csv("C:/Users/akash/Desktop/Walmart Sales Prediciton/input/stores.csv", names=['Store','Type','Size'],sep=',', header=0)
...
def scatter(dataset, column):
    plt.figure()
    plt.scatter(dataset[column] , dataset['Quantity Sold'])
...
#
scatter(dataset, 'Price')
scatter(dataset, 'Brand')
scatter(dataset, 'Quality(%)')
scatter(dataset, 'Category')
scatter(dataset, 'ProductID')
...
for name, group in dataset.groupby(["Store", "Dept"]):
    plt.title(name)
    plt.scatter(range(len(group)), group["Quality Sold"])
    plt.show()
    break
...
#test
dataset_test = pd.read_csv("C:/Users/akash/Desktop/Walmart Sales Prediciton/input/test.csv", names=['Store','Dept','Date','isHoliday'],sep=',', header=0)
features = pd.read_csv("C:/Users/akash/Desktop/Walmart Sales Prediciton/input/features.csv",sep=',', header=0,
                       names=['Store','Date','Temperature','Fuel_Price','MarkDown1','MarkDown2','MarkDown3','MarkDown4',
                              'MarkDown5','CPI','Unemployment','IsHoliday']).drop(columns=['IsHoliday'])
stores = pd.read_csv("C:/Users/akash/Desktop/Walmart Sales Prediciton/input/stores.csv", names=['Store','Type','Size'],sep=',', header=0)
